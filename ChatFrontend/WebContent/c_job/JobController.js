myApp.controller("JobController",function($scope,$rootScope,$http,$location)
{
	...
	$scope.publishJob=function()
	{
		...
		$http.post('http://localhost:8082/ChatMiddleware/addJob',$scope.job)
	...
	function listJobs()
	{
		$http.get('http://localhost:8082/ChatMiddleware/listJobs')
		.then(function(response)
				{
	...
	$scope.deleteJob=function(jobId)
	{
		...
		$http.get('http://localhost:8082/ChatMiddleware/deleteJob/'+jobId)
		.then(function(response)
				{
