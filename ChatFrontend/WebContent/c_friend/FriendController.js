myApp.controller("FriendController",function($scope,$rootScope,$http,$location)
{
	...
	function showFriendList()
	{
		...
		$http.get('http://localhost:8082/ChatMiddleware/showFriendList')
	...
	function showPendingFriendList()
	{
		...
		$http.get('http://localhost:8082/ChatMiddleware/showPendingFriendRequest')
		.then(function(response)
				{
	...
	function showSuggestedFriendList()
	{
		...
		$http.get('http://localhost:8082/ChatMiddleware/showSuggestedFriend')
		.then(function(response)
				{
